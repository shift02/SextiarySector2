...
public class ContainerSimpleMachine extends Container {
	...
	public ContainerSimpleMachine(InventoryPlayer par1InventoryPlayer, TileEntitySimpleMachine par2TileEntityFurnace)
	{
		...
		this.addSlotToContainer(new SlotGF(par2TileEntityFurnace, 1, 56, 53, this.machine.getMaxPowerStored(ForgeDirection.UP)));
	...
	public void addCraftingToCrafters(ICrafting par1ICrafting)
	{
		...
		par1ICrafting.sendProgressBarUpdate(this, 4, this.machine.storage.getSpeedStored());
	}
	...
	public void detectAndSendChanges()
	{
		...
		for (int i = 0; i < this.crafters.size(); ++i)
		{
			...
			{
				icrafting.sendProgressBarUpdate(this, 4, this.machine.storage.getSpeedStored());
			}
		...
		this.lastSpeed = this.machine.storage.getSpeedStored();
	}
