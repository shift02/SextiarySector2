...
public class ContainerShippingBox extends Container {
	...
	public ContainerShippingBox(InventoryPlayer par1InventoryPlayer, EntityPlayer p_i1819_3_)
	{
		...
		for (i = 0; i < 9; ++i)
		{
			this.addSlotToContainer(new SlotRucksack(par1InventoryPlayer, i, 8 + i * 18, 142));
		}
		...
		for (i = 0; i < 3; ++i)
		{
			for (int j = 0; j < 9; ++j)
			{
				this.addSlotToContainer(new SlotRucksack(par1InventoryPlayer, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
			}
		}
	}
