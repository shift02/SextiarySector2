...
public abstract class AbstractFuel2RecipeHandler extends AbstractSimple2RecipeHandler {
    ...
    private ArrayList<SimpleMachinePair> mfurnace = new ArrayList<AbstractSimple2RecipeHandler.SimpleMachinePair>();

    public AbstractFuel2RecipeHandler() {
        super();
        loadAllSmelting();
    }
    ...
    abstract Class<? extends AbstractSimple2RecipeHandler> getFuelHandlerClass();
