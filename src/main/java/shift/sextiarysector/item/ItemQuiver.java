...
public class ItemQuiver extends Item implements IEquipment, ISSEquipment {
    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {
        player.openGui(SextiarySector.instance, 207, world, (int) player.posX, (int) player.posY, (int) player.posZ);
        return itemStack;
    }
    ...
    public void onTabClicked(EquipmentType equipment, ItemStack stack, EntityPlayer player) {
        SSPacketHandler.INSTANCE.sendToServer(new PacketGuiId(208));
