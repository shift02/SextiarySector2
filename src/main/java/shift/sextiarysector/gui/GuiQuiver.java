...
public class GuiQuiver extends GuiContainer {
    ...
    public GuiQuiver(InventoryPlayer inventoryPlayer) {
        super(new ContainerQuiver(inventoryPlayer));
        //this.ySize = 222;
    }

    public GuiQuiver(InventoryPlayer inventoryPlayer, InventoryPlayerNext inventoryPlayerN) {
        super(new ContainerQuiver(inventoryPlayer, inventoryPlayerN));
        tab = true;
        //this.ySize = 222;
    }
    ...
    public void initGui() {
        ...
        TabManager.updateTabValues(cornerX, cornerY, this.buttonList, SSPlayerTabs.quiver, false);
    ...
    protected void drawGuiContainerForegroundLayer(int x, int p_146979_2_) {
        ...
        this.fontRendererObj.drawString(
                I18n.format("gui.ss.quiver"),
                this.xSize / 2 - this.fontRendererObj.getStringWidth(I18n.format("gui.ss.quiver")) / 2, 6, 4210752);
