...
{
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("sextiarysector:textures/guis/funnel.png");
	private final TileEntityFunnel tileFurnace;

	public GuiFunnel(InventoryPlayer p_i1091_1_, TileEntityFunnel p_i1091_2_)
	{
		super(new ContainerFunnel(p_i1091_1_, p_i1091_2_));
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
		...
		if (this.tileFurnace.isFluid())
		{
			...
			this.drawFluidTank(k + 62, l + 20, this.tileFurnace.getTank(), 52, 16);

		}
		this.mc.getTextureManager().bindTexture(furnaceGuiTextures);
		this.drawTexturedModalRect(k + 61, l + 19, 176, 0, 53, 17);
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		GL11.glPushMatrix();
		if (this.func_146978_c(61, 19, 53, 17, par1, par2))
		{
