...
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("sextiarysector:textures/guis/magic_furnace.png");
    private TileEntityMagicFurnace tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public GuiMagicFurnace(InventoryPlayer p_i1091_1_, TileEntityMagicFurnace p_i1091_2_)
    {
        super(new ContainerMagicFurnace(p_i1091_1_, p_i1091_2_));
