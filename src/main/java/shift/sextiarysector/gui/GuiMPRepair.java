...
public class GuiMPRepair extends GuiContainer implements ICrafting {
    private static final ResourceLocation field_147093_u = new ResourceLocation("textures/gui/container/anvil.png");
    private final ContainerMPRepair field_147092_v;
    private GuiTextField field_147091_w;
    private final InventoryPlayer field_147094_x;

    public GuiMPRepair(InventoryPlayer p_i1073_1_, World p_i1073_2_, int p_i1073_3_, int p_i1073_4_, int p_i1073_5_) {
        super(new ContainerMPRepair(p_i1073_1_, p_i1073_2_, p_i1073_3_, p_i1073_4_, p_i1073_5_, Minecraft.getMinecraft().thePlayer));
        this.field_147094_x = p_i1073_1_;
        this.field_147092_v = (ContainerMPRepair) this.inventorySlots;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        this.fontRendererObj.drawString(I18n.format("container.ss.repair", new Object[0]), 60, 6, 4210752);

        if (this.field_147092_v.maximumCost > 0) {
            int k = 8453920;
            boolean flag = true;
            String s = I18n.format("container.ss.repair.cost", new Object[] { Integer.valueOf(this.field_147092_v.maximumCost) });

            if (this.field_147092_v.maximumCost >= 10000 && !this.mc.thePlayer.capabilities.isCreativeMode) {
