...
public class SSBlocks {
	...
	public static void initBlicks(){
		...
		shaft = new BlockShaft().setBlockName("ss.wood_shaft").setCreativeTab(CreativeTabs.tabBlock);
		...
		smallWindmill = new BlockSmallWindmill().setBlockName("ss.small_windmill").setCreativeTab(CreativeTabs.tabBlock);
		...
		millstone = new BlockSimpleMachine("millstone",20,SSRecipes.millstone).setBlockName("ss.millstone").setCreativeTab(CreativeTabs.tabBlock);
