...
public class TileEntityKnife extends TileEntityDirection implements IFluidHandler {

    public FluidTank tank = new FluidTank(FluidContainerRegistry.BUCKET_VOLUME * 2);
    protected int lastAmount;

    protected ItemBox items = new ItemBox("Knife", 1);
    ...
    public void setKnife(ItemStack item) {
        item.stackSize = 1;
