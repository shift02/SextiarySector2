...
public class TileEntityFreezer  extends TileEntitySimpleFurnace{
	...
	protected ItemStack getResult(ItemStack stackInSlot) {
		return SSRecipes.freezer.getResult(stackInSlot);
	}
	...
	public int getItemFuelTime(ItemStack p_145952_0_)
    {
        ...
        {
        	return SSRecipes.iceFuel.getResult(p_145952_0_);
        }
    }
	...
	public String getInventoryName() {
		return "gui.ss.freezer";//+SimpleMachine.values()[this.worldObj.getBlockMetadata(xCoord, yCoord, zCoord)].icon+".name";
	}
