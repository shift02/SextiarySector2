...
public class TileEntityLargeWindmill extends TileEntityDirection implements IGearForceHandler, IGearForceGrid {
    ...
    public void updateServerEntity() {
        ...
        if (t != null && t instanceof IGearForceHandler && this.isWork()) {
            ...
            ((IGearForceHandler) t).addEnergy(this.direction, 3, 20, false);
        }
