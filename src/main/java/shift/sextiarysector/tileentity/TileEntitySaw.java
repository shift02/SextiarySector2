...
public class TileEntitySaw  extends TileEntityDirection  implements IGFEnergyHandler ,IGearForceGrid{
	...
	private AxisAlignedBB getDirectionAABB(){
		...
		switch(direction){
		case DOWN: minY = -1; break;
		case UP: maxY = 2; break;
		case NORTH: minZ = -1; break;
		case SOUTH: maxZ = 2; break;
		case WEST: minX = -1; break;
		case EAST: maxX = 2; break;
		default:break;
		}
