...
public class TileEntityShaft extends TileEntityDirection implements IGearForceHandler, IGearForceGrid, IShaft {
    ...
    public void updateClientEntity() {
        ...
        for (int i = 2; t instanceof IShaft && ((IShaft) t).getDirection().ordinal() == this.direction.ordinal(); i++) {
            ...
            t = this.worldObj.getTileEntity(xCoord + this.getOutDirection().offsetX * i, yCoord + this.getOutDirection().offsetY * i,
    ...
    public TileEntity getInTileEntity() {
        return this.worldObj.getTileEntity(xCoord + this.getInDirection().offsetX, yCoord + this.getInDirection().offsetY,
                zCoord + this.getInDirection().offsetZ);
    }

    public TileEntity getOutTileEntity() {
        return this.worldObj.getTileEntity(xCoord + this.getOutDirection().offsetX, yCoord + this.getOutDirection().offsetY,
