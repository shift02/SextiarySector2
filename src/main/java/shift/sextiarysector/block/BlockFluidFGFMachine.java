...
public class BlockFluidFGFMachine extends BlockContainer {
	...
	private final RecipeSimpleFluid recipe;
	private String guiuUnlocalizedName;
	private final int type;

	public BlockFluidFGFMachine(String iconFront, int gui, RecipeSimpleFluid recipe, int type) {
	...
	{
		int d = ((TileEntityFluidFGFMachineBase) par1IBlockAccess.getTileEntity(par2, par3, par4)).direction.ordinal();
	...
	private void setDefaultDirection(World par1World, int par2, int par3, int par4)
	{
		if (!par1World.isRemote)
		{
			...
			((TileEntityFluidFGFMachineBase) par1World.getTileEntity(par2, par3, par4)).direction = ForgeDirection.getOrientation(b0);
			...
			ItemStack par6ItemStack)
	{
		...
		if (l == 0)
		{
			...
			((TileEntityFluidFGFMachineBase) par1World.getTileEntity(par2, par3, par4)).direction = ForgeDirection
					.getOrientation(2);
		}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
	{
		...
		TileEntityFluidFGFMachineBase tileentityfurnace = (TileEntityFluidFGFMachineBase) par1World.getTileEntity(par2, par3, par4);
	...
	public FluidStack getFluidResult(ItemStack itemstack) {
		return this.recipe.getFluidResult(itemstack);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityFluidFGFMachineBase(type);
	}
}
