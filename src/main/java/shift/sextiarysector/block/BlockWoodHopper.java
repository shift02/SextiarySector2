...
public class BlockWoodHopper extends BlockHopper{
    ...
    {
        this.field_149921_b = p_149651_1_.registerIcon("sextiarysector:hopper_outside");
        this.field_149923_M = p_149651_1_.registerIcon("sextiarysector:hopper_top");
        this.field_149924_N = p_149651_1_.registerIcon("sextiarysector:hopper_inside");
    }
