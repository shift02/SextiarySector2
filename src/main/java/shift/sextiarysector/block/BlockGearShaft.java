...
public class BlockGearShaft extends BlockDirection {

	private int type;

	public BlockGearShaft(int type) {
		super(Material.wood);
		this.setType(type);
	...
	public double[] getBoxFromPool(World par1World, int par2, int par3, int par4)
	{
		...
		if (!(par1World.getTileEntity(par2, par3, par4) instanceof TileEntityDirection)) return i;
