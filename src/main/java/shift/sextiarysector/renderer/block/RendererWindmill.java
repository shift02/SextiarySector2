...
public class RendererWindmill extends TileEntitySpecialRenderer  implements ISimpleBlockRenderingHandler{

	private static final ResourceLocation windmillTextures = new ResourceLocation("sextiarysector:textures/models/windmill.png");
	static public ModelBase modelWindmill = new ModelWindmill();
	...
	public int getRenderId() {
		return SextiarySector.proxy.windMillType;
	}
	@Override
